let data = [
  ...
  { hiragana: 'っか', katakana: 'ッカ', romaji: 'kka' },
  { hiragana: 'っき', katakana: 'ッキ', romaji: 'kki' },
  { hiragana: 'っく', katakana: 'ック', romaji: 'kku' },
  { hiragana: 'っけ', katakana: 'ッケ', romaji: 'kke' },
  { hiragana: 'っこ', katakana: 'ッコ', romaji: 'kko' },
  { hiragana: 'っさ', katakana: 'ッサ', romaji: 'ssa' },
  { hiragana: 'っし', katakana: 'ッシ', romaji: 'sshi' },
  { hiragana: 'っす', katakana: 'ッス', romaji: 'ssu' },
  { hiragana: 'っせ', katakana: 'ッセ', romaji: 'sse' },
  { hiragana: 'っそ', katakana: 'ッソ', romaji: 'sso' },
  { hiragana: 'った', katakana: 'ッタ', romaji: 'tta' },
  { hiragana: 'っち', katakana: 'ッチ', romaji: 'tchi' },
  { hiragana: 'っつ', katakana: 'ッツ', romaji: 'ttsu' },
  { hiragana: 'って', katakana: 'ッテ', romaji: 'tte' },
  { hiragana: 'っと', katakana: 'ット', romaji: 'tto' },
  { hiragana: 'っぱ', katakana: 'ッパ', romaji: 'ppa' },
  { hiragana: 'っぴ', katakana: 'ッピ', romaji: 'ppi' },
  { hiragana: 'っぷ', katakana: 'ップ', romaji: 'ppu' },
  { hiragana: 'っぺ', katakana: 'ッペ', romaji: 'ppe' },
  { hiragana: 'っぽ', katakana: 'ッポ', romaji: 'ppo' },
  { hiragana: 'っきゃ', katakana: 'ッキャ', romaji: 'kkya' },
  { hiragana: 'っきゅ', katakana: 'ッキュ', romaji: 'kkyu' },
  { hiragana: 'っきょ', katakana: 'ッキョ', romaji: 'kkyo' },
  { hiragana: 'っしゃ', katakana: 'ッシャ', romaji: 'ssha' },
  { hiragana: 'っしゅ', katakana: 'ッシュ', romaji: 'sshu' },
  { hiragana: 'っしょ', katakana: 'ッショ', romaji: 'ssho' },
  { hiragana: 'っちゃ', katakana: 'ッチャ', romaji: 'tcha' },
  { hiragana: 'っちゅ', katakana: 'ッチュ', romaji: 'tchu' },
  { hiragana: 'っちょ', katakana: 'ッチョ', romaji: 'tcho' },
  { hiragana: 'っぴゃ', katakana: 'ッピャ', romaji: 'ppya' },
  { hiragana: 'っぴゅ', katakana: 'ッピュ', romaji: 'ppyu' },
  { hiragana: 'っぴょ', katakana: 'ッピョ', romaji: 'ppyo' },
];
export default data;
